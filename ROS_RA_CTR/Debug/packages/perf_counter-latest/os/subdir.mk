...
OBJS += \
./packages/perf_counter-latest/os/perf_os_patch_rt_thread.o 

C_DEPS += \
./packages/perf_counter-latest/os/perf_os_patch_rt_thread.d 


# Each subdirectory must supply rules for building sources it contributes
packages/perf_counter-latest/os/%.o: ../packages/perf_counter-latest/os/%.c
